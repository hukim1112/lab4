...
class Dataset(object):
    ...
    human_det_path = osp.join(root_path, 'datasets', dataset_name,
                              'dets', 'human_detection.json')  # human detection result
    # osp.join(root_path, 'datasets', dataset_name, 'images')
    img_path = config.image_path
    train_annot_path = osp.join(
        config.dataset_path, 'annotations', 'person_keypoints_train2017.json')
    val_annot_path = osp.join(
        config.dataset_path, 'annotations', 'person_keypoints_val2017.json')
    test_annot_path = osp.join(
        config.dataset_path, 'annotations', 'image_info_test-dev2017.json')
